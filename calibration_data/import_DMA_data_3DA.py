...
directory = './VN01_001_DMA_results/3DA'
output_file = './VN01_001_DMA_results/3DA/visco_properties_3DA_data.xlsx'

# From the sheet
strain_total = 0.0936456 + 0.000186767 #[mm/mm]
stress_t1600 = 36190.6

# Define the mat. props. to use
E_0 = (stress_t1600/strain_total)/10e6 #MPa, for 3 day dose (stress relaxation experiment @ 1600 s)
