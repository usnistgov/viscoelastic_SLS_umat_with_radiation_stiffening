...
directory = './VN01_001_DMA_results/1DA'
output_file = './VN01_001_DMA_results/1DA/visco_properties_1DA_data.xlsx'

strain_total = 0.0933466 + 0.000098677 #[mm/mm]
stress_t1600 = 16506 #Pa

# Define the mat. props. to use
E_0 = (stress_t1600/strain_total)/10e6 #MPa, for 1 day dose (stress relaxation experiment @ 1600 s)
