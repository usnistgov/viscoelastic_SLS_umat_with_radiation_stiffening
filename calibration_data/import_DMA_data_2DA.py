...
directory = './VN01_001_DMA_results/2DA'
output_file = './VN01_001_DMA_results/2DA/visco_properties_2DA_data.xlsx'

strain_total = 0.0930491 + 0.000128907 #[mm/mm]
stress_t1600 = 11851.8 #Pa

# Define the mat. props. to use
E_0 = (stress_t1600/strain_total)/10e6 #MPa, for 2 day dose (stress relaxation experiment @ 1600 s)
